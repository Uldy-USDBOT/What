...
# what.ly – Reference Index

A clean, fast, SEO-optimized "What is...?" reference index, redesigned around a library-catalog
visual identity (index cards, call numbers, drawer tabs). Built with pure HTML, CSS, and
...
- ✅ **54 entries on file** (AI, crypto, climate change, SEO, VPN, NFTs, cybersecurity, etc.)
- ✅ **"Most looked up" strip** – surfaces and internally links the site's top SEO-priority topics
- ✅ **Instant search** – filter questions as you type, including keyword matches
- ✅ **Full SEO pass** – unique per-page titles/descriptions, Open Graph + Twitter cards,
  canonical links, JSON-LD (WebSite + SearchAction, FAQPage, BreadcrumbList), a sitemap
  that lists every individual answer page, and internal "related entries" linking
